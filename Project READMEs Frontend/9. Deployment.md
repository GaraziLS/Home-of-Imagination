...
### If this keeps throwing issues, here's the solution I came up with: revert BrowserRouter back to HashRouter, and put a # in the API routes and/or the homepage line in the package.json.

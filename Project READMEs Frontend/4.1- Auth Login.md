...
Since we changed to React v6 in order to upload content to GitHub pages, the props.history.push command doesn't work.
...
We have to change this to ``this.props.navigate``.